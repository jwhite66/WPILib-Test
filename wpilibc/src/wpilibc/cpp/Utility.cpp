...
bool wpi_assert_impl(bool conditionValue, llvm::StringRef conditionText,
  ...
  char fname[60];
  char ext[10];
  _splitpath_s(fileName.c_str(fileTemp), nullptr, 0, nullptr, 0, fname, 60, ext, 10);
...
#else
  static std::string demangle(char const* mangledSymbol) { return "no demangling on windows"; }
